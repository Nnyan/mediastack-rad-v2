...
api:
  dashboard: true
  # insecure: true exposes the API on :8081 for direct LAN access.
  # Port 8081 is also mapped to the host — the dashboard is available
  # at http://<host-ip>:8081/dashboard/ and routed through Traefik
  # itself at traefik.<domain> with Tinyauth auth.
  insecure: true
